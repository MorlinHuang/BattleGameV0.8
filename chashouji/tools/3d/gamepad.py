...
跑：blender -b --python gamepad.py -- 36 249 128 <out> 1
    pack_atlas.py <帧目录> gamepad_atlas.webp --cell 160

    渲染边长 249 = 单格 160 / 并集占比 0.647。common.py 说描边宽度是
...
render_turntable('gamepad', active=shell, lean=35, tilt=0.26, roll=0.90)
